"""E7 project provisioning — capture-once / replay (PREREG E7 v2.2 §3 B7).
...
Determinism note (§3 B7): there is NO re-generation path here — ffmpeg
...
log = logging.getLogger("forge.explore.provision7")
